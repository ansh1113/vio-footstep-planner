...
class VIONavigator:
    ...
    def _initialize_vio(self):
        ...
        camera_intrinsics = np.array([[615.0, 0.0, 320.0], [0.0, 615.0, 240.0], [0.0, 0.0, 1.0]])

        # Default IMU parameters
        imu_params = {"acc_n": 0.2, "gyr_n": 0.02, "acc_w": 0.002, "gyr_w": 0.0002}
        ...
        if self.drift_correction_enabled:
            ...
            self.drift_corrector = DriftCorrector(
                loop_closure_threshold=0.7, enable_pose_graph_optimization=True
            )
